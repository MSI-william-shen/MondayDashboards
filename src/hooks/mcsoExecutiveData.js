...
import { 
  MCSO_ActionRegister_Tracker,
  MCSO_SubmittalLog_Tracker,
  MCSO_RFILog_Tracker,
  MCSO_SSRS_Tracker,
  MCSO_Interface_Tracker,
  MCSO_RiskRegister_Tracker
} from '@api/BoardSDK.js';

export const mcsoExecutiveData = () => {
  ...
  const fetchBoardData = useCallback(async () => {
    ...
    try {
      const sdk = {
        action: new MCSO_ActionRegister_Tracker(),
        ssrs: new MCSO_SSRS_Tracker(),
        interface: new MCSO_Interface_Tracker(),
        rfi: new MCSO_RFILog_Tracker(),
        sub: new MCSO_SubmittalLog_Tracker(),
        risk: new MCSO_RiskRegister_Tracker()        
      };
